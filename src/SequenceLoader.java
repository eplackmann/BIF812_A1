...
public abstract class SequenceLoader {
	 ...
	 * 
	 * @param filepath
	 *            the path to the file that contains the sequence to load
	 */
	...
	/**
	 * Loads a sequence from the indicated filepath and tests the time required
	 * to concatenate the sequence with itself the indicated number of times
	 * 
	 * @param filepath
	 *            the path to the file that contains the sequence
	 * @param times
	 *            the number of times to concatenate sequence to itself
	 * @return time elapsed in nanoseconds required to concatenate sequence to
	 *         itself the indicated number of times
	 */
	...
	/**
	 * tests the time required to concatenate the sequence with itself the
	 * indicated number of times if sequence is null, the user will select a
	 * file form which to load the sequence
	 * 
	 * @param times
	 *            the number of times to concatenate sequence to itself
	 * @return time elapsed in nanoseconds required to concatenate sequence to
	...
	/**
	 * This method will concatenate String s to the end of sequence the
	 * indicated number of times
	 * 
	 * @param s
	 *            the string to concatenate to the end of sequence
	 * @param times
	 *            the number of times s will be concatenated to the end sequence
	 */
